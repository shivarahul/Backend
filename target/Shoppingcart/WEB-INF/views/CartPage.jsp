            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <div class="thumbnail">
                         <a class="thumbnail pull-left" href="#"> <img src="/frontend/myImage/imageDisplay?id=${cart.productid}" style="height:50px;height: 50px" > </a>
                    ...
                    <tr>
                        ...
                        <td class="text-right"><h5><strong>5 Days</strong></h5></td>
                    </tr>
                    <tr>
                        <td>   </td>
                        <td>   </td>
